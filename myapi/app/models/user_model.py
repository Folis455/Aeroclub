...
class Usuarios(db.Model):
    ...
    roles = db.relationship("Roles", secondary="USUARIOS_tiene_ROLES", back_populates="usuarios") # back_populates es relación birediccional
    ...
    cuenta_corriente = db.relationship("CuentaCorriente", uselist=False, backref="usuarios") #uselist=False es 1 a 1; backref unidireccional
...
class Recibos(db.Model):
    ...
    def __init__(self, id_recibos ,fecha, observaciones, tipo_recibos_id, transacciones_id):
